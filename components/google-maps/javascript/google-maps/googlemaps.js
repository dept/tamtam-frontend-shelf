...
import { MAP_SETTINGS, MAP_MARKER, MAP_MARKER_ACTIVE, MAP_MAX_ZOOM, MAP_API_KEY, DEFAULT_REGIONS } from './map-settings.js';
...
class GoogleMaps {
    ...
    changeRegion( data ) {
        ...
        if( selectedRegionID === '-1' ) {
            ...
            const locations = ( selectedRegion ) ? [...selectedRegion.querySelectorAll( HOOK_LOCATION )] : this.getLocationsByRegionId( selectedRegionID );
