...
class Cookies {
    constructor() {
        ...
        this.cookiebarOptionsButton = document.querySelector(
            COOKIE_OPTIONS_BUTTON_HOOK
        );
        ...
        if (this.form.element) {
            ...
            this.form.options = [
                ...this.form.element.querySelectorAll(COOKIE_OPTION_HOOK)
            ];
            this.form.submit = this.form.element.querySelector(
                COOKIE_FORM_SUBMIT_HOOK
            );
        }
    ...
    _setDefaultCookies() {
        this.config.cookies.forEach(cookie => {
            if (
                ...
                cookie.default === COOKIE_DEFAULT_VALUE
            ) {
    ...
    _acceptAllCookies() {
        ...
        this.config.cookies.forEach(cookie => {
            ...
            acceptedCookies[
                this.prefixCookieName(cookie.name)
            ] = COOKIE_DEFAULT_VALUE;
        });
